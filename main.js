...
var updateGroupChoices = function () {
  ...
  var listItem = document.createElement("li");
  listItem.innerHTML =
    '<input type="radio" name="group" id="all"' +
...
var pickRandom = function (e) {
  ...
  var priorities = Array.from(
    new Set(
      unpickedChoices.map(function (item) {
...
function copyResults() {
  var copyText = document.querySelector("#logs");
  copyText.select();
